...
const STRINGS = {
  ...
  'chat.members': { ja: 'メンバー({count})', en: 'Members ({count})' },
  'chat.creator': { ja: '作成者', en: 'Creator' },
  'chat.addMembers': { ja: 'メンバーを追加', en: 'Add members' },
  'chat.noMoreMembers': { ja: '追加できるメンバーはいません。', en: 'Everyone is already in this group.' },
  'chat.add': { ja: '追加', en: 'Add' },
  'chat.leaveGroup': { ja: 'グループを退出', en: 'Leave group' },
  'chat.confirmLeave': {
    ja: 'このグループを退出しますか？退出すると、このグループの会話は見られなくなります。',
    en: 'Leave this group? You will no longer be able to see its conversation.',
  },
  'chat.removeMember': { ja: 'グループから外す', en: 'Remove from group' },
  'chat.confirmRemove': { ja: '{name}さんをグループから外しますか？', en: 'Remove {name} from this group?' },
